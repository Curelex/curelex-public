...
const Doctor = sequelize.define("Doctor", {
  ...
  photoPublicId: { type: DataTypes.STRING, allowNull: true },
  certificateUrl: { type: DataTypes.STRING, allowNull: true },
  certificatePublicId: { type: DataTypes.STRING, allowNull: true },

  // ── Step 3: Professional Experience ──
  experience: { type: DataTypes.INTEGER, allowNull: true },
  qualification: { type: DataTypes.STRING, allowNull: true },
  currentInstitute: { type: DataTypes.STRING, allowNull: true },
  ...
  qrCodePublicId: { type: DataTypes.STRING, allowNull: true },

  // ── Consultation Fee — set by Admin when approving ✅ NEW ──
  consultationFee: {
    type: DataTypes.INTEGER,
    allowNull: true,
    defaultValue: null,
    comment: 'Fee per consultation in INR, set by admin during approval',
  },
  ...
  profileComplete: { type: DataTypes.BOOLEAN, defaultValue: false, allowNull: false },
}, {
  timestamps: true,
});
